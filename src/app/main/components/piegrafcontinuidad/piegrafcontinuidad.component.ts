...
import { MATRIZ_CONTINUIDAD, MATRIZ_FRAUDE, MATRIZ_OPORTUNIDAD } from 'src/app/shared/Constantes'
import * as zingchart from 'zingchart';
@Component({
  selector: 'app-piegrafcontinuidad',
  templateUrl: './piegrafcontinuidad.component.html',
  styleUrls: ['./piegrafcontinuidad.component.scss']
})

export class PieGrafContinuidadComponent implements OnInit {
    ...
    idMatrizF : number=MATRIZ_CONTINUIDAD;
