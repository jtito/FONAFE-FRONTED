...
@Component({
  selector: 'app-piegraffraude',
  templateUrl: './piegraffraude.component.html',
  styleUrls: ['./piegraffraude.component.scss']
})

export class PieGrafFraudeComponent implements OnInit {
    ...
    idMatrizF : number=MATRIZ_FRAUDE;
