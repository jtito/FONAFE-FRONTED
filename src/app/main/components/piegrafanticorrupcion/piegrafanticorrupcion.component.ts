...
@Component({
  selector: 'app-piegrafanticorrupcion',
  templateUrl: './piegrafanticorrupcion.component.html',
  styleUrls: ['./piegrafanticorrupcion.component.scss']
})

export class PieGrafAnticorrupcionComponent implements OnInit {
    ...
    idMatrizF : number=MATRIZ_ANTICORRUPCION;
