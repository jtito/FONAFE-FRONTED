...
export class ContraseniaComponent implements OnInit {
    ...
    constructor(private contraseniaService: ContraseniaService, private formBuilder: FormBuilder, private router: Router,
        ...
        if (nuevaContrasenia != confirmContrasenia) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    const contraseniaEncript = this.payload.data.password;
