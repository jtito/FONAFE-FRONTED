...
import { MATRIZ_ANTICORRUPCION } from 'src/app/shared/Constantes'
...
@Component({
    selector : 'app-dash-matrizAnticorrupcion',
    templateUrl : './matriz-anticorrupcion.component.html',
    styleUrls: ['./matriz-anticorrupcion.component.css']
})
...
export class MatrizAnticorrupcionComponent implements OnInit {
  ...
  idEmpresa: number;
  idPeriodo: number;  
  idMatriz : number=MATRIZ_ANTICORRUPCION;
  estado: string;
