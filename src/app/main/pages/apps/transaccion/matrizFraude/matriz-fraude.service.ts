...
import {CODIGO_PARAMETRO_INDICADOR_SI_NO,CODIGO_PARAMETRO_MATRIZ,CODIGO_PARAMETRO_TIPO_MATRIZ,CODIGO_PARAMETRO_CARTERA, CODIGO_PARAMETRO_ORIGEN_RIESGO, CODIGO_PARAMETRO_FRECUENCIA_RIESGO, CODIGO_PARAMETRO_TIPO_RIESGOF, CODIGO_PARAMETRO_AREA_RESPONSABLE, CODIGO_PARAMETRO_FRECUENCIA_CONTROL, CODIGO_PARAMETRO_OPORTUNIDAD_CONTROL, CODIGO_PARAMETRO_AUTOMATIZACION_CONTROL, CODIGO_PARAMETRO_RESPONSABLE_CONTROL, CODIGO_PARAMETRO_ESTADO,CODIGO_PARAMETRO_EFICAZ_PLAN_ACCION, CODIGO_PARAMETRO_MATRIZ_FRAUDE, CODIGO_PARAMETRO_ESTRATEGIA_RESPUESTA, CODIGO_PARAMETRO_ESTADO_PLAN_ACCION, CODIGO_CANTIDAD_CONTROL} from "../../../../../shared/Constantes";
...
export class MatrizFraudeService {
    ...
    urlEndpointMatrizFraude = `${environment.apiUrl}/gestionriesgo/matrizFraude`;
    ...
    listarBandejaMatrizRiesgo(idEmpresa: number, idPeriodo: number, idMatrizNivel: number): Observable<any>{
        return this.httpClient.get(this.urlEndpointMatrizRiesgo + '/listarBandejaMatrizRiesgo/' + idEmpresa + '/' + idPeriodo + '/' + idMatrizNivel, {}).pipe(
            catchError(
                e => {
                    console.error('Error al intentar listar la bandeja de matriz de fraude. Msg: ' + e.error);
                    if (Swal.isLoading()) {
                        Swal.close();
                    }
                    Swal.fire('Error', 'Ocurrió un error inesperado.<br><br>Intente nuevamente por favor.', 'error');
    ...
    listarBandejaMatrizFraude(idEmpresa: number, idPeriodo: number, idMatrizNivel: number): Observable<any>{
        return this.httpClient.get(this.urlEndpointMatrizFraude + '/listarBandejaMatrizFraude/' + idEmpresa + '/' + idPeriodo + '/' + idMatrizNivel, {}).pipe(
            catchError(
                e => {
                    console.error('Error al intentar listar la bandeja de matriz de fraude. Msg: ' + e.error);
                    if (Swal.isLoading()) {
    ...
    obtenerListaOrigenRiesgo(): Observable<any> {
        return this.httpClient.get(this.urlEndpointParametro + '/listarParametrosxCodigo/' + CODIGO_PARAMETRO_ORIGEN_RIESGO, {}).pipe(
            catchError(
                e => {
                    console.error('Error al intentar listar los origenes de fraude. Msg: ' + e.error);
                    if (Swal.isLoading()) {
                        Swal.close();
                    }
                    Swal.fire('Error', 'Ocurrió un error inesperado.<br><br>Intente nuevamente por favor.', 'error');
    ...
    obtenerListaTiposRiesgo(): Observable<any> {
        return this.httpClient.get(this.urlEndpointParametro + '/listarParametrosxCodigo/' + CODIGO_PARAMETRO_TIPO_RIESGOF, {}).pipe(
            catchError(
                e => {
    ...
    obtenerMatrizRiesgo(idMatrizRiesgo: number, idUsuario: number):Observable<any>{
        return this.httpClient.get(this.urlEndpointMatrizFraude + '/obtenerMatrizFraude/' + idMatrizRiesgo +"/"+ idUsuario, {}).pipe(
            catchError(
                e => {
    ...
    registrarMatrizFraude(matrizRiesgo: MatrizFraude): Observable<any> {
        return this.httpClient.post(this.urlEndpointMatrizFraude + '/registrarMatrizFraude', matrizRiesgo).pipe(
            catchError(
                e => {
                    console.error('Error al intentar editar la matriz de riesgo. Msg: ' + e.error);
                    if (Swal.isLoading()) {
    ...
    actualizarMatrizFraude(matrizRiesgo: MatrizFraude): Observable<any> {
        return this.httpClient.put(this.urlEndpointMatrizFraude + '/actualizarMatrizFraude', matrizRiesgo).pipe(
            catchError(e => {
