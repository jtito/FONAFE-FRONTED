...
export class RiesgoInherenteComponent implements OnInit {
  ...
  cartesianPoints:cartesianPoint[]=[];
    ...
    ngOnInit(): void {
        ...
        console.log("GRAPH DATA "+JSON.stringify(this.config.graphset[0].series));
    ...
    setheatarea(){
      ...
      this.config.graphset[0].series.push({
        ...
        values: [[2.5,3.25],[2.5,4.0],[3.25,4.0],[3.25,3.25],[4.0,3.25]],
        marker: {
          size: 1,
        },
      ...
      this.config.graphset[0].series.push({
        ...
        values: [[1.75,3.25],[1.75,4.0],[2.5,4.0],[2.5,3.25],[3.25,3.25],[3.25,2.5],[4.0,2.5]],
        marker: {
          size: 1,
        },
      ...
      this.config.graphset[0].series.push({
          ...
          values: [[1,4.0],[1.75,4.0],[1.75,3.25],[2.5,3.25],[2.5,2.5],[3.25,2.5],[3.25,1.75],[4.0,1.75]],
          marker: {
            size: 1,
          },
          aspect: "segmented",
